"""Per-clip configuration: everything about a clip that the file itself can't tell you."""
import csv
...
def to_bool(text, field):
    """CSV has no types. bool('false') is True — so parse explicitly, and
    refuse anything ambiguous instead of guessing."""
